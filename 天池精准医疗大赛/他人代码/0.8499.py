...
train = pd.read_csv('../data/d_train_20180102.csv',encoding='gb18030')
test = pd.read_csv('../data/d_test_A_20180102.csv',encoding='gb18030')
...
for i in tqdm(range(num_ensembles)):
    model = CatBoostRegressor(iterations=1000, learning_rate=0.03, depth=6, l2_leaf_reg=3,  loss_function='RMSE', eval_metric='RMSE', random_seed=i)
